...
var _user$project$Msg$SetCols = function (a) {
	return {ctor: 'SetCols', _0: a};
};
var _user$project$Msg$SetRows = function (a) {
...
var _user$project$Model$Model = F8(
	function (a, b, c, d, e, f, g, h) {
		return {minRows: a, maxRows: b, curRows: c, minCols: d, maxCols: e, curCols: f, csvData: g, errors: h};
	});
...
var _user$project$View$slider = F5(
	function (name, min, max, current, msg) {
		return {
			ctor: '::',
			_0: A2(
				_elm_lang$html$Html$input,
				{
					...
					_0: _elm_lang$html$Html_Attributes$value(
						(_elm_lang$core$Native_Utils.cmp(current, min) > -1) ? _elm_lang$core$Basics$toString(current) : ''),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html_Events$on,
...
var _user$project$View$viewInput = function (model) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		{
			ctor: '::',
			_0: _elm_lang$html$Html$text('Flashcard Printer!'),
			_1: {ctor: '[]'}
		},
		A2(
			_elm_lang$core$Basics_ops['++'],
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Click here for details'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				},
				A2(
					...
					A2(
						_elm_lang$core$Basics_ops['++'],
						A5(_user$project$View$slider, 'columns', model.minCols, model.maxCols, model.curCols, _user$project$Msg$SetCols),
						A2(
							_elm_lang$core$Basics_ops['++'],
							{
								ctor: '::',
							...
							A2(
								_elm_lang$core$Basics_ops['++'],
								A5(_user$project$View$slider, 'rows', model.minRows, model.maxRows, model.curRows, _user$project$Msg$SetRows),
								A2(
									_elm_lang$core$Basics_ops['++'],
									{
										ctor: '::',
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Select a CSV flashcard file: '),
										_1: {
											ctor: '::',
											_0: A2(
												_elm_lang$html$Html$input,
												{
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$id('CSVInput'),
														_1: {
															ctor: '::',
															_0: A2(
																_elm_lang$html$Html_Events$on,
...
var _user$project$View$regroup = F2(
	function (n, xs) {
		var _p0 = A2(_elm_lang$core$List$take, n, xs);
		if (_p0.ctor === '[]') {
			return {ctor: '[]'};
		} else {
			return {
				...
				_0: _p0,
				_1: A2(
					_user$project$View$regroup,
					n,
					A2(_elm_lang$core$List$drop, n, xs))
			};
		}
	});
var _user$project$View$viewSheet = F3(
	function (rows, columns, pairs) {
		var dashedBorder = {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'border', _1: '1px dotted #AAA'},
			_1: {ctor: '[]'}
		};
		var flipText = {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: '-webkit-transform', _1: 'rotate(-180deg)'},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: '-moz-transform', _1: 'rotate(-180deg)'},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: '-webkit-transform', _1: 'rotate(-180deg)'},
					_1: {
						ctor: '::',
						_0: {ctor: '_Tuple2', _0: '-ms-transform', _1: 'rotate(-180deg)'},
						_1: {
							ctor: '::',
							_0: {ctor: '_Tuple2', _0: '-o-transform', _1: 'rotate(-180deg)'},
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'transform', _1: 'rotate(-180deg)'},
								_1: {ctor: '[]'}
							}
						}
					}
			...
			_0: {
				...
				_1: A2(
					...
					_elm_lang$core$Basics$toString(
						(1.0 / _elm_lang$core$Basics$toFloat(columns)) * 100),
					'%')
			},
			_1: {
				ctor: '::',
				_0: {
					...
					_1: A2(
						_elm_lang$core$Basics_ops['++'],
						_elm_lang$core$Basics$toString(
							(1.0 / _elm_lang$core$Basics$toFloat(rows)) * 100),
						'%')
				},
				_1: {
					ctor: '::',
		...
		var frontStyle = _elm_lang$html$Html_Attributes$style(textStyle);
		var backStyle = _elm_lang$html$Html_Attributes$style(
			A2(
				_elm_lang$core$Basics_ops['++'],
				textStyle,
				A2(_elm_lang$core$Basics_ops['++'], dashedBorder, flipText)));
				...
				_1: {
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'border-style', _1: 'hidden'},
								_1: {
									ctor: '::',
									_0: {ctor: '_Tuple2', _0: 'break-after', _1: 'page'},
									_1: {ctor: '[]'}
								}
							}
						}
		...
		var defecit = (rows * columns) - _elm_lang$core$List$length(pairs);
		var padding = A2(
		...
		var paddedPairs = A2(_elm_lang$core$Basics_ops['++'], pairs, padding);
		var frontWords0 = A2(
			_elm_lang$core$List$map,
			function (_p1) {
				return A2(
		...
		var frontWords = A2(
			...
			rows,
			A2(_user$project$View$regroup, columns, frontWords0));
		var frontTable = A2(
		...
		var backWords = A2(
			...
			A2(
				...
				A2(_user$project$View$regroup, columns, backWords0)));
		var backTable = A2(
			_elm_lang$html$Html$table,
			{
				ctor: '::',
...
var _user$project$View$viewFile = function (model) {
	var cols = model.curCols;
	var rows = model.curRows;
	var cdata = {ctor: '::', _0: model.csvData.headers, _1: model.csvData.records};
	var pairs = A2(
		_elm_lang$core$List$filter,
		function (ls) {
			return _elm_lang$core$Native_Utils.eq(
				_elm_lang$core$List$length(ls),
				2);
		},
		cdata);
	var rgpairs = A2(_user$project$View$regroup, rows * cols, pairs);
	return A2(
		_elm_lang$core$List$concatMap,
		A2(_user$project$View$viewSheet, rows, cols),
		rgpairs);
};
	...
	return A2(
		...
		function () {
			...
			if (_p3.ctor === 'Just') {
				...
				return _elm_lang$core$List$isEmpty(model.csvData.records) ? _user$project$View$viewInput(model) : _user$project$View$viewFile(model);
			}
		}());
};

var _user$project$Main$stringToCount = F4(
	function (minVal, curVal, maxVal, s) {
		...
		if (_p0.ctor === 'Err') {
			...
			var _p1 = {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.cmp(_p2, minVal) < 0,
				_1: _elm_lang$core$Native_Utils.cmp(_p2, maxVal) > 0
			};
			_v1_2:
			do {
				if (_p1.ctor === '_Tuple2') {
			...
			case 'SetRows':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							curRows: A4(_user$project$Main$stringToCount, model.minRows, model.curRows, model.maxRows, _p3._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'SetCols':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							curCols: A4(_user$project$Main$stringToCount, model.minCols, model.curCols, model.maxCols, _p3._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'FileSelected':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Ports$fileSelected('CSVInput')
				};
			default:
				var _p4 = _periodic$elm_csv$Csv$parse(_p3._0);
				if (_p4.ctor === 'Ok') {
					return {
						ctor: '_Tuple2',
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{csvData: _p4._0, errors: _elm_lang$core$Maybe$Nothing}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								errors: _elm_lang$core$Maybe$Just(_p4._0)
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}
...
var _user$project$Main$main = _elm_lang$html$Html$program(
	{init: _user$project$Model$init, update: _user$project$Main$update, view: _user$project$View$view, subscriptions: _user$project$Main$subscriptions})();
